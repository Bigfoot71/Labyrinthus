...
function camera.firstPersonMovement(dt)
    ...
    local speed = 9
    if love.keyboard.isScancodeDown "w" then moveX = moveX + 1 end
    if love.keyboard.isScancodeDown "a" then moveY = moveY + 1 end
    if love.keyboard.isScancodeDown "s" then moveX = moveX - 1 end
    if love.keyboard.isScancodeDown "d" then moveY = moveY - 1 end
